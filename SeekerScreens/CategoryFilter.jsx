...
export default function CategoryFilter({navigation, route}) {
    const priceRange = [
        { key: 100, value: '₱1 - ₱100'},
    ...
    const [selectedCity, setSelectedCity] = filterQuery != {} ? filterQuery.selectedCity != "" ? useState(filterQuery.selectedCity) : useState('') : useState('');
    const [selectedBarangay, setSelectedBarangay] = filterQuery != {} ? filterQuery.selectedBarangay != null ? useState(filterQuery.selectedBarangay) : useState('') : useState('');
    const [selectedPriceRange, setSelectedPriceRange] = filterQuery != {} ? filterQuery.selectedPriceRange != null ? useState(filterQuery.selectedPriceRange) : useState(null) : useState(null);
    const [selectedRating, setSelectedRating] = filterQuery != {} ? filterQuery.selectedRating != null ? useState(filterQuery.selectedRating) : useState(null) : useState(null);
    ...
    return (
        ...
        >
          ...
          <View>
            ...
            title="Clear"
            color="#002F45"
            onPress={() => {setClear(!clear); setSelectedCity(""); setSelectedBarangay(""); setSelectedPriceRange(null); setSelectedRating(null);}}
            />
            </View>
        </View>
        </ScrollView>   
